	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Utilization Analysis <small></small>
				</h1>
				<ol class="breadcrumb">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<form method="post" action="MPAS_Utilization.jsp">
									<input type="text" name="actname" /> <input type="submit"
						...
						<div class="box box-danger">
							...
							<div class="box-body">
								...
								<%
									if (actname != null) {
								%>
								<h3 class="box-title"><%=actname%>'s Utilization rate is
									<%=utilization * 100%>%
								</h3>
								...
								<strong><h1>
										->
										<%=actname%>
										Activity has High probability <BR> to be BottleNeck
										Operation.
									</h1></strong>
								<%
								...
								<strong><h1>
										->
										<%=actname%>
										Activity has Some probability <BR> to be BottleNeck
										Operation.
									</h1></strong>
								<%
									} else {
								...
								<strong><h1>
										->
										<%=actname%>
										Activity has Low probability <BR> to be BottleNeck
										Operation.
									</h1></strong>
								<%
									}
						...
						<div class="box box-info">
							...
							<div class="box-body">
								...
								<%
									if (actname != null) {
								%>
								<h3 class="box-title"><%=actname%>'s WorkTime :<%=worktime%>
									Seconds
								</h3>
								<h3 class="box-title"><%=actname%>'s TotalTime :<%=totaltime%>
									Seconds
								</h3>
								<br>
								<br>
